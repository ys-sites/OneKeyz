        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-start">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-1">
              <a
                href="#music"
                className="flex-1 inline-flex items-center justify-center gap-2.5 bg-[#E6007E] hover:bg-[#C8006E] text-white font-sleek font-bold text-xs uppercase tracking-[0.16em] px-6 py-3.5 rounded-full shadow-xl shadow-pink-500/20 border border-pink-400/30 transition-all transform hover:-translate-y-0.5 text-center"
              >
              ...
              <a
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white font-sleek font-bold text-xs uppercase tracking-[0.16em] px-6 py-3.5 rounded-full border border-white/15 transition-all text-center"
              >
          ...
          >
            ...
            {/* Song-Driven Signature Lyric & Direct Music Push Card with Signature Autograph */}
            <motion.div
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="inline-flex items-center gap-1.5 bg-[#E6007E]/10 border border-[#E6007E]/30 text-pink-300 text-[10px] font-sleek font-bold px-2.5 py-0.5 rounded-full uppercase tracking-[0.16em]">
                  <Disc3 className="w-3 h-3 text-[#E6007E] animate-spin-slow" />
                  Featured Lyric • "REAL" (2025)
                </span>
              </div>
              <blockquote className="font-signature text-2xl sm:text-3xl text-white font-normal leading-snug tracking-wide signature-stamp">
                "Don’t give me the version you sell to the world. Strip it all back and give me something REAL."
              </blockquote>
              <div className="pt-3 border-t border-white/10 flex flex-wrap items-center justify-between gap-3 text-xs">
                <span className="text-pink-300 font-bold uppercase tracking-widest flex items-center gap-2">
                  <span className="font-signature text-2xl text-[#E6007E] font-bold lowercase tracking-normal -rotate-3">~ Onekeyz</span>
                  <span className="text-gray-500">•</span>
                  <span className="text-gray-400 font-sleek text-[11px] uppercase tracking-wider">Official Single "REAL"</span>
                </span>
                <a
                  href="#music"
                  className="text-pink-300 hover:text-white transition-colors underline decoration-[#E6007E] font-sleek font-bold text-xs uppercase tracking-wider flex items-center gap-1"
                >
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-[#E6007E]/50 transition-colors space-y-1">
                ...
                <span className="text-xs font-sleek font-bold uppercase text-pink-300 tracking-[0.16em] block">
                  GENRE & STYLE
                </span>
            ...
            <motion.div variants={itemVariants} className="pt-2">
              <div className="p-3 rounded-xl bg-pink-950/30 border border-[#E6007E]/30 flex items-center gap-2.5 text-xs text-pink-200">
                ...
                <span className="font-sleek text-[11px] tracking-wide">
